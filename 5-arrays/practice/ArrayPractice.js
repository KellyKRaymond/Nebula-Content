// const topPixarMovies = ["cars" , "toy story"]
...
//you can change the original array with this 
...
let dataTypeArray = ["String", "Number" , "Boolean" , "Objects" , "Null"]

// Make a list of classmates names first names in an array

let classMatesArray = ["Jordan" , "Dan" , "Kelly"]
...
Array.classMatesArray(names)

// Using indexing, grab your name from that previous array
console.log(classMatesArray[2])
...
classMatesArray = [0] = "Jordan Gant"
classMatesArray = [1] = "Daniel Delacruz"
classMatesArray = [2] = "Kelly Raymond"
...
if(classMatesArray.indexOf(1) === -1){
    console.log(false)
}
else{
    console.log(true)
