...
const celebNames = ["Jen Anniston" , "David Schwimmer" , "Matthew Perry" , "Matt LeBlanc" , "Courtney Cox" , "Lisa Cudrow"]
...
// //      If a celebrity's full name has an even number of characters log it to the console
  for(let i = 0; i < celebNames.length; i++){
 console.log(celebNames[i],length)
